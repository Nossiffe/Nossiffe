...
## 🚀 Projet personnel — PipeImmo (en production)
...
**Backend** · C# · .NET Framework → .NET 9 · .NET MAUI · Web API · SignalR · DDD · CQRS · Microservices · SQL Server · PostgreSQL · Azure Cosmos DB · Service Bus

**Frontend** · Angular 4 → 19 · TypeScript · RxJS · PrimeNG · Angular Material

**Cloud & DevOps** · Azure (App Services, Functions, Storage, Key Vault…) · Azure DevOps · GitLab CI · Docker · SonarQube · OVHcloud
